...
Responsive CSS in React Native is one of the biggest pain for developer.
...
Here, I'm measuring WINDOW WIDTH of device on which app is running.
And then as per the above calculation I have delcared two global function.
scaleSize() and scaleFont() that I'm using with css.
scaleSize() for all the height and width related properties. And
scaleFont() for font specific css properties.
